...
var (
	_ larry.Batch       = (*mongoBatch)(nil)
	_ larry.Database    = (*mongoDB)(nil)
	_ larry.Iterator    = (*mongoIterator)(nil)
	_ larry.Range       = (*mongoRange)(nil)
	_ larry.Transaction = (*mongoTX)(nil)
)
...
func NewMongoDB(cfg *MongoConfig) (larry.Database, error) {
	if cfg == nil {
...
func (b *mongoDB) Begin(ctx context.Context, write bool) (larry.Transaction, error) {
...
func (b *mongoDB) execute(ctx context.Context, write bool, callback func(ctx context.Context, tx larry.Transaction) error) error {
...
func (b *mongoDB) View(ctx context.Context, callback func(ctx context.Context, tx larry.Transaction) error) error {
	return b.execute(ctx, false, callback)
}

func (b *mongoDB) Update(ctx context.Context, callback func(ctx context.Context, tx larry.Transaction) error) error {
	return b.execute(ctx, true, callback)
}

func (b *mongoDB) NewIterator(ctx context.Context, table string) (larry.Iterator, error) {
	if _, ok := b.tables[table]; !ok {
		return nil, larry.ErrTableNotFound
	}
	co := b.db.Database(internalDB).Collection(table)
...
func (b *mongoDB) NewRange(ctx context.Context, table string, start, end []byte) (larry.Range, error) {
	if _, ok := b.tables[table]; !ok {
		return nil, larry.ErrTableNotFound
	}
	co := b.db.Database(internalDB).Collection(table)
...
func (b *mongoDB) NewBatch(ctx context.Context) (larry.Batch, error) {
	return &mongoBatch{
		db: b,
