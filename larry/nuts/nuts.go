...
var (
	_ larry.Batch       = (*nutsBatch)(nil)
	_ larry.Database    = (*nutsDB)(nil)
	_ larry.Iterator    = (*nutsIterator)(nil)
	_ larry.Range       = (*nutsRange)(nil)
	_ larry.Transaction = (*nutsTX)(nil)
)
...
func NewNutsDB(cfg *NutsConfig) (larry.Database, error) {
	if cfg == nil {
...
func (b *nutsDB) Begin(_ context.Context, write bool) (larry.Transaction, error) {
...
func (b *nutsDB) execute(ctx context.Context, write bool, callback func(ctx context.Context, tx larry.Transaction) error) error {
...
func (b *nutsDB) View(ctx context.Context, callback func(ctx context.Context, tx larry.Transaction) error) error {
	return xerr(b.execute(ctx, false, callback))
}

func (b *nutsDB) Update(ctx context.Context, callback func(ctx context.Context, tx larry.Transaction) error) error {
	return xerr(b.execute(ctx, true, callback))
}

func (b *nutsDB) NewIterator(ctx context.Context, table string) (larry.Iterator, error) {
...
func (b *nutsDB) NewRange(ctx context.Context, table string, start, end []byte) (larry.Range, error) {
	tx, err := b.Begin(ctx, false)
	if err != nil {
		return nil, xerr(err)
	}
...
func (b *nutsDB) NewBatch(ctx context.Context) (larry.Batch, error) {
...
func (tx *nutsTX) Write(ctx context.Context, b larry.Batch) error {
	bb, ok := b.(*nutsBatch)
	if !ok {
