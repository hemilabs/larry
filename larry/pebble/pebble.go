...
func NewPebbleDB(cfg *PebbleConfig) (larry.Database, error) {
	if cfg == nil {
...
func (b *pebbleDB) NewBatch(ctx context.Context) (larry.Batch, error) {
...
func (tx *pebbleTX) Write(ctx context.Context, b larry.Batch) error {
